...
BLOG_AUTHOR = "Chrisdona Joan C. Paraiso"  # (translatable)
BLOG_TITLE = "Chrisdona Joan's Github Profile"  # (translatable)
...
BASE_URL = "/"
BLOG_EMAIL = "paraiscc@plu.edu"
BLOG_DESCRIPTION = "Chrisdona Joan's Github Profile"  # (translatable)
